...
starbucks_positive <- read_csv("starbucks_positive.csv")
starbucks_negative <- read_csv("starbucks_negative.csv")
...
#Clustering by Unemployment, Consumer Sentiment, and Income of each state
...
set.seed(15)
km_out <- kmeans(final_final_state_factors, centers = 3, nstart = 20)
