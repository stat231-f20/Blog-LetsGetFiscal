...
# apply the k-means algorithm (set the seed to make the results reproducible)
set.seed(75)
tn_county_km <- kmeans(tn_final_county_factors, centers = 3, nstart = 20)
...
# apply the k-means algorithm (set the seed to make the results reproducible)
set.seed(75)
co_county_km <- kmeans(co_final_county_factors, centers = 3, nstart = 20)
...
# apply the k-means algorithm (set the seed to make the results reproducible)
set.seed(75)
ca_county_km <- kmeans(ca_final_county_factors, centers = 3, nstart = 20)
