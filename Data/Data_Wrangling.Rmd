...
ggplot() +
  geom_polygon(data = usa_states, aes(x=long, y = lat, group = group), color="blue", fill="black", alpha=0.3) +
  geom_point(data=city_count_star, aes(x = Longitude, y = Latitude, group=group, size=Count)) +
  theme_void() 
